...
import numpy as np
import pickle
encodes=pd.read_csv(r'C:/Users/saipr/Downloads/Capstone Projects/final_enc.csv')
model=pickle.load(open(r'C:/Users/saipr/Downloads/Capstone Projects/flight_final.pkl','rb'))
...
def main():
    ...
    if st.button("Predict"):
        ...
        st.balloons()
    st.subheader('Developed by: Saiprasad Reddy')
